...
from typing import Annotated, Any, List, Optional, cast, get_type_hints
...
def load_yaml_config() -> dict[Any, Any]:
    ...
    try:
        ...
        with open(yaml_path, "r", encoding="utf-8") as f:
            ...
            return cast(dict[Any, Any], data) if data is not None else {}
